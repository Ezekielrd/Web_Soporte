        ...
        panel.classList.add('d-none');
            ...
            async function cargarResumenNotificaciones() {
                try {
                    ...
                    data.items.forEach(n => {
                        ...
                        item.href = `/Notificaciones/Abrir/${n.id}`;
                    ...
                    <div class="text-muted text-truncate">${n.mensaje}</div>
                `;
            ...
            // 👇 NUEVO: dejar disponible para otros scripts
            window.reloadNotificacionesResumen = cargarResumenNotificaciones;
